...
def object_obs(
    ...
    left_eef_idx = env.scene["robot"].data.body_names.index("wrist_roll_l_link")
    right_eef_idx = env.scene["robot"].data.body_names.index("wrist_roll_r_link")
...
def get_head_state(
    ...
    head_joint_names = ["head_yaw_joint"]
