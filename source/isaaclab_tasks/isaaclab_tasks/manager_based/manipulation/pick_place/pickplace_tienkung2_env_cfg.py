...
from isaaclab.devices.openxr.retargeters.humanoid.x_humanoid.tienkung2_retargeter import Tienkung2RetargeterCfg
...
from . import mdp_tienkung2 as mdp

from isaaclab_assets.robots.tienkung_2 import TIENKUNG_2_CFG  # isort: skip
...
class ObjectTableSceneCfg(InteractiveSceneCfg):
    ...
    robot: ArticulationCfg = TIENKUNG_2_CFG.replace(
...
@configclass
class PickPlaceTienKung2EnvCfg(ManagerBasedRLEnvCfg):
