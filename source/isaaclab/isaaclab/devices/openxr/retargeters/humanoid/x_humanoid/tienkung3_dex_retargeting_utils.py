...
class TienKung3DexRetargeting:
    ...
    def __init__(
        ...
        right_hand_config_filename: str = "tienkung3_hand_right_dexpilot.yml",
        left_hand_config_filename: str = "tienkung3_hand_left_dexpilot.yml",
        left_hand_urdf_path: str = f"/data/weyan/Revo2_URDF_Description_ROS1/urdf/revo2_left_hand.urdf",
        right_hand_urdf_path: str = f"/data/weyan/Revo2_URDF_Description_ROS1/urdf/revo2_right_hand.urdf",
    ):
        ...
        omni.log.info("[Tienkung3DexRetargeter] init done.")
