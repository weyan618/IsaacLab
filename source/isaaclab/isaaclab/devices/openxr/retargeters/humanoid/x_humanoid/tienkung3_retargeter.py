...
with contextlib.suppress(Exception):
    from .tienkung3_dex_retargeting_utils import TienKung3DexRetargeting

@dataclass
class TienKung3RetargeterCfg(RetargeterCfg):
    """Configuration for the Tienkung3 retargeter."""

    enable_visualization: bool = False
    num_open_xr_hand_joints: int = 52
    hand_joint_names: list[str] | None = None  # List of robot hand joint names

class TienKung3Retargeter(RetargeterBase):
    """Retargets OpenXR hand tracking data to Tienkung3 hand end-effector commands.

    This retargeter maps hand tracking data from OpenXR to joint commands for the TienKung3 robot's hands.
    It handles both left and right hands, converting poses of the hands in OpenXR format joint angles for the TienKung3 robot's hands.
    """

    def __init__(
        self,
        cfg: TienKung3RetargeterCfg
    ):
        """Initialize the TienKung3 hand retargeter.
        ...
        self._hands_controller = TienKung3DexRetargeting(self._hand_joint_names)
    ...
    def retarget(self, data: dict) -> torch.Tensor:
        ...
        left_retargeted_hand_joints[indexes] = left_hand_pos
        ...
        right_retargeted_hand_joints[indexes] = right_hand_pos
        ...
        #print("-----------------")
        #print(retargeted_hand_joints)

        #debug
        #retargeted_hand_joints = np.zeros(22)
